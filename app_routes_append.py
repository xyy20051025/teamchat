...
def get_dashboard_data():
    ...
    # In a real app, this should be more sophisticated or use a separate table
    ...
    for m in recent_msgs:
        if m.content and any(k in m.content.lower() for k in keywords):
            warnings.append({
                ...
                'level': 'High' # Mock level
            })
    
    # 4. Room Activity List
    # Get all rooms with their member count and today's msg count
